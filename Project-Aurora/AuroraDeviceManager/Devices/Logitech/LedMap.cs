...
{
    public static readonly ImmutableDictionary<DeviceKeys, int> BitmapMap = new Dictionary<DeviceKeys, int>
    {
        [DeviceKeys.ESC] = 0,
        [DeviceKeys.F1] = 4,
        [DeviceKeys.F2] = 8,
    ...
    public static readonly ImmutableDictionary<DeviceKeys, KeyboardNames> KeyMap = new Dictionary<DeviceKeys, KeyboardNames>
    {
    ...
    public static readonly ImmutableDictionary<DeviceKeys, (DeviceType type, int zone)> PeripheralMap =
        new Dictionary<DeviceKeys, (DeviceType, int)>
        {
            ...
            [DeviceKeys.HEADSET2] = (DeviceType.Headset, 1),
            [DeviceKeys.HEADSET3] = (DeviceType.Headset, 2),
            [DeviceKeys.HEADSET4] = (DeviceType.Headset, 3),

            [DeviceKeys.MOUSEPADLIGHT1] = (DeviceType.Mousemat, 0),

            [DeviceKeys.CL2] = (DeviceType.Speaker, 0),
            [DeviceKeys.CL3] = (DeviceType.Speaker, 1),
            [DeviceKeys.CL4] = (DeviceType.Speaker, 2),
            [DeviceKeys.CL5] = (DeviceType.Speaker, 3),
        }.ToImmutableDictionary();
}