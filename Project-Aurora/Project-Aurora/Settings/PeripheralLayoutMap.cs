...
public static class PeripheralLayoutMap
{
    ...
    public static readonly IReadOnlyDictionary<PreferredMouse, string> MouseLayoutMap = new Dictionary<PreferredMouse, string>
    {
          ...
          {PreferredMouse.Logitech_G900, "logitech_g900_features2.json"},
          {PreferredMouse.Logitech_G502, "logitech_g502_features2.json"},
          {PreferredMouse.Logitech_G102, "logitech_g102_features2.json"},
