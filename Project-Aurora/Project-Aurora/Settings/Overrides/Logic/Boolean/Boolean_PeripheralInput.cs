...
public class BooleanKeyDown : Evaluatable<bool> {
    ...
    public override Visual GetControl() => new StackPanel { Orientation = Orientation.Horizontal }
        ...
        .WithChild(new Control_FieldPresenter { Type = typeof(Keys) }
...
public class BooleanKeyDownWithTimer : Evaluatable<bool> {
    ...
    public override Visual GetControl() => new StackPanel()
        .WithChild(new StackPanel { Orientation = Orientation.Horizontal }
            ...
            .WithChild(new Control_FieldPresenter { Type = typeof(Keys), Margin = new System.Windows.Thickness(0, 0, 0, 6) }
                .WithBinding(Control_FieldPresenter.ValueProperty, new Binding("TargetKey") { Source = this, Mode = BindingMode.TwoWay })))
        .WithChild(new StackPanel { Orientation = Orientation.Horizontal }
            .WithChild(new TextBlock { Text = "For" })
            .WithChild(new Control_FieldPresenter { Type = typeof(float), Margin = new System.Windows.Thickness(5, 0, 5, 6) }
                .WithBinding(Control_FieldPresenter.ValueProperty, new Binding("Seconds") { Source = this, Mode = BindingMode.TwoWay }))
...
public class BooleanMouseDown : Evaluatable<bool> {
    ...
    public override Visual GetControl() => new StackPanel { Orientation = Orientation.Horizontal }
        ...
        .WithChild(new Control_FieldPresenter { Type = typeof(System.Windows.Forms.MouseButtons), Margin = new System.Windows.Thickness(0, 0, 0, 6) }
