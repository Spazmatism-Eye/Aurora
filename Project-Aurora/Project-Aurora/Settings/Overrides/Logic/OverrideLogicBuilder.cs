...
public class OverrideLogicBuilder {
    ...
    private readonly Dictionary<string, IOverrideLogic> _overrideProperties = new();
    ...
    /// </summary>
    public Dictionary<string, IOverrideLogic> Create() => _overrideProperties;
    ...
    private OverrideLogicBuilder SetDynamic(Type type, string layerPropertyName, IEvaluatable evaluatable) {
        _overrideProperties[layerPropertyName] = new OverrideDynamicValue(type, new Dictionary<string, IEvaluatable> { { "Value", evaluatable } });
        return this;
    }
    ...
    public OverrideLogicBuilder SetDynamicColor(string layerPropertyName, Evaluatable<double> a, Evaluatable<double>r, Evaluatable<double>g, Evaluatable<double>b) {
        _overrideProperties[layerPropertyName] = new OverrideDynamicValue(typeof(System.Drawing.Color), new Dictionary<string, IEvaluatable> {
    ...
    public OverrideLogicBuilder SetLookupTable(string layerPropertyName, Type t, IEnumerable<OverrideLookupTable.LookupTableEntry> entries) {
        _overrideProperties[layerPropertyName] = new OverrideLookupTable(t, entries);
        return this;
    }
...
public class OverrideLookupTableBuilder<T> {
    ...
    private readonly List<OverrideLookupTable.LookupTableEntry> _entries = new();
    ...
    public OverrideLookupTableBuilder<T> AddEntry(T value, Evaluatable<bool> when) {
        _entries.Add(new OverrideLookupTable.LookupTableEntry(value, when));
        return this;
    }

    public IEnumerable<OverrideLookupTable.LookupTableEntry> Create() => _entries;
}