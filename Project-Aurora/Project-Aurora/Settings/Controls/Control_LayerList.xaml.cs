...
public partial class Control_LayerList : INotifyPropertyChanged {
    ...
    private static object? Clipboard { get; set; }
    ...
    public static readonly DependencyProperty SelectedLayerProperty =
        DependencyProperty.Register(nameof(SelectedLayer), typeof(Layer), typeof(Control_LayerList), new PropertyMetadata(null, OnSelectedLayerPropertyChanged));
    ...
    private void PasteButton_Click(object? sender, EventArgs e)
    {
        ...
        if (Clipboard is not Layer clipboardLayer) return;
