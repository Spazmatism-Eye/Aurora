    ...
    public class Dota2HeroAbilityEffectsLayerHandler : LayerHandler<Dota2HeroAbilityEffectsLayerHandlerProperties>
    {
        ...
        public override EffectLayer Render(IGameState state)
        {
                ...
                for (var abilityId = 0; abilityId < dota2State.Abilities.Count; abilityId++)
                {
                    ...
                    switch (ability.Name)
                    {
                        ...
                        case "lina_laguna_blade":
                        {
                            ...
                            var lagunaPoint1 = new PointF(0, Effects.Canvas.HeightCenter + ((_randomizer.Next() % 2 == 0 ? 1.0f : -1.0f) * 6.0f * (float)_randomizer.NextDouble()));
                            var lagunaPoint2 = new PointF(Effects.Canvas.WidthCenter + 3.0f, Effects.Canvas.HeightCenter + ((_randomizer.Next() % 2 == 0 ? 1.0f : -1.0f) * 6.0f * (float)_randomizer.NextDouble()));
                            var lagunaPoint3 = new PointF(Effects.Canvas.WidthCenter + 6.0f, Effects.Canvas.HeightCenter + ((_randomizer.Next() % 2 == 0 ? 1.0f : -1.0f) * 6.0f * (float)_randomizer.NextDouble()));
                            var lagunaPoint4 = new PointF(Effects.Canvas.WidthCenter + 9.0f, Effects.Canvas.HeightCenter + ((_randomizer.Next() % 2 == 0 ? 1.0f : -1.0f) * 6.0f * (float)_randomizer.NextDouble()));

                            _linaLagunaBladeTrack.SetFrame(0.0f,
                                new AnimationLines(
                                    new AnimationLine[] {
                                        new(new PointF(0, Effects.Canvas.HeightCenter), lagunaPoint1, Color.FromArgb(255, 255, 255), 2),
                            ...
                            _linaLagunaBladeTrack.SetFrame(0.5f,
                                new AnimationLines(
                                    new AnimationLine[] {
                                        new(new PointF(0, Effects.Canvas.HeightCenter), lagunaPoint1, Color.FromArgb(0, 255, 255, 255), 2),
                        ...
                        case "abaddon_death_coil":
                        {
                            ...
                            var deathCoilPoint1 = new PointF(Effects.Canvas.WidthCenter - 3.0f, Effects.Canvas.HeightCenter + ((_randomizer.Next() % 2 == 0 ? 1.0f : -1.0f) * 6.0f * (float)_randomizer.NextDouble()));
                            var deathCoilPoint2 = new PointF(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter + ((_randomizer.Next() % 2 == 0 ? 1.0f : -1.0f) * 6.0f * (float)_randomizer.NextDouble()));
                            var deathCoilPoint3 = new PointF(Effects.Canvas.WidthCenter + 3.0f, Effects.Canvas.HeightCenter + ((_randomizer.Next() % 2 == 0 ? 1.0f : -1.0f) * 6.0f * (float)_randomizer.NextDouble()));
                            var deathCoilPoint4 = new PointF(Effects.Canvas.WidthCenter + 9.0f, Effects.Canvas.HeightCenter + ((_randomizer.Next() % 2 == 0 ? 1.0f : -1.0f) * 6.0f * (float)_randomizer.NextDouble()));

                            _abaddonDeathCoilTrack.SetFrame(0.0f,
                                new AnimationLines(
                                    new AnimationLine[] {
                                        new(new PointF(0, Effects.Canvas.HeightCenter), deathCoilPoint1, Color.FromArgb(0, 160, 210), 2),
                            ...
                            _abaddonDeathCoilTrack.SetFrame(0.5f,
                                new AnimationLines(
                                    new AnimationLine[] {
                                        new(new PointF(0, Effects.Canvas.HeightCenter), deathCoilPoint1, Color.FromArgb(0, 0, 160, 210), 2),
                        ...
                        case "zuus_arc_lightning":
                        {
                            ...
                            var zuusLightningPoint1 = new PointF(Effects.Canvas.WidthCenter - 3.0f, Effects.Canvas.HeightCenter + ((_randomizer.Next() % 2 == 0 ? 1.0f : -1.0f) * 6.0f * (float)_randomizer.NextDouble()));
                            var zuusLightningPoint2 = new PointF(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter + ((_randomizer.Next() % 2 == 0 ? 1.0f : -1.0f) * 6.0f * (float)_randomizer.NextDouble()));
                            var zuusLightningPoint3 = new PointF(Effects.Canvas.WidthCenter + 3.0f, Effects.Canvas.HeightCenter + ((_randomizer.Next() % 2 == 0 ? 1.0f : -1.0f) * 6.0f * (float)_randomizer.NextDouble()));
                            var zuusLightningPoint4 = new PointF(Effects.Canvas.WidthCenter + 9.0f, Effects.Canvas.HeightCenter + ((_randomizer.Next() % 2 == 0 ? 1.0f : -1.0f) * 6.0f * (float)_randomizer.NextDouble()));

                            _zuusArcLightningTrack.SetFrame(0.0f,
                                new AnimationLines(
                                    new AnimationLine[] {
                                        new(new PointF(0, Effects.Canvas.HeightCenter), zuusLightningPoint1, Color.FromArgb(0, 205, 255), 2),
                            ...
                            _zuusArcLightningTrack.SetFrame(0.5f,
                                new AnimationLines(
                                    new AnimationLine[] {
                                        new(new PointF(0, Effects.Canvas.HeightCenter), zuusLightningPoint1, Color.FromArgb(0, 0, 205, 255), 2),
            ...
            switch (_currentAbilityEffect)
            {
                case Dota2AbilityEffects.RazorPlasmaField:
                    _razorPlasmaFieldTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.CrystalMaidenCrystalNova:
                    _crystalMaidenCrystalNovaTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.RikiSmokeScreen:
                    _rikiSmokeScreenTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.LinaDragonSlave:
                    _linaDragonSlaveTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.LinaLightStrikeArray:
                    _linaLightStrikeArrayTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.LinaLagunaBlade:
                    _linaLagunaBladeTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.AbaddonDeathCoil:
                    _abaddonDeathCoilTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                ...
                case Dota2AbilityEffects.NevermoreShadowraze:
                    _nevermoreShadowrazeTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.NevermoreRequiem:
                    _nevermoreRequiemTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.ZuusArcLightning:
                    _zuusArcLightningTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.ZuusLightningBolt:
                    _zuusLightningBoltShadeTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _zuusLightningBoltTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                ...
                case Dota2AbilityEffects.AntimageBlink:
                    _antimageBlinkTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.AntimageManaVoid:
                    _antimageManaVoidTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _antimageManaVoidCoreTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                ...
                case Dota2AbilityEffects.AncientApparitionIceBlast:
                    _ancientApparitionIceBlastTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                ...
                case Dota2AbilityEffects.AxeBerserkersCall:
                    _axeBerserkersCallTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.BeastmasterPrimalRoar:
                    _beastmasterPrimalRoarTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.BrewmasterThunderClap:
                    _brewmasterThunderClapTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.CentaurHoofStomp:
                    _centaurHoofStompTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.ChaosKnightChaosBolt:
                    _chaosKnightChaosBoltMix.Draw(graphics, _abilityEffectKeyframe);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.RattletrapRocketFlare:
                    _rattletrapRocketFlareTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                ...
                case Dota2AbilityEffects.DragonKnightBreatheFire:
                    _dragonKnightBreatheFireTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                ...
                case Dota2AbilityEffects.ElderTitanEarthSplitter:
                    _elderTitanEarthSplitterTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.KunkkaTorrent:
                    _kunkkaTorrentMix.Draw(graphics, _abilityEffectKeyframe);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.KunkkaGhostship:
                    _kunkkaGhostshipTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.LegionCommanderOverwhelmingOdds:
                    _legionCommanderOverwhelmingOddsTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.LifeStealerRage:
                    _lifeStealerRageTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.MagnataurShockwave:
                    _magnataurShockwaveTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.OmniknightPurification:
                    _omniknightPurificationTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.OmniknightRepel:
                    _omniknightRepelTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.SandkingEpicenter:
                    _sandkingEpicenterMix.Draw(graphics, _abilityEffectKeyframe);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
                case Dota2AbilityEffects.SlardarSlithereenCrush:
                    _slardarSlithereenCrushTrack.GetFrame(_abilityEffectKeyframe).Draw(graphics);
                    _abilityEffectKeyframe += GetDeltaTime();
                    break;
            }
        ...
        private void UpdateAnimations()
        {
            ...
            _razorPlasmaFieldTrack.SetFrame(0.0f,
                new AnimationCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(0, 200, 255), 3)
                );
            _razorPlasmaFieldTrack.SetFrame(1.0f,
                new AnimationCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 200, 255), 3)
                );
            ...
            _crystalMaidenCrystalNovaTrack.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Height / 2.0f, Color.FromArgb(0, 200, 255))
                );
            _crystalMaidenCrystalNovaTrack.SetFrame(0.5f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.75f / 2.0f, Color.FromArgb(0, 200, 255))
                );
            _crystalMaidenCrystalNovaTrack.SetFrame(1.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 0, 200, 255))
                );

            _rikiSmokeScreenTrack = new AnimationTrack("Riki Smoke Screen", 6.5f);
            _rikiSmokeScreenTrack.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Height / 2.0f, Color.FromArgb(163, 70, 255))
                );
            _rikiSmokeScreenTrack.SetFrame(5.525f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.75f / 2.0f, Color.FromArgb(163, 70, 255))
                );
            _rikiSmokeScreenTrack.SetFrame(6.5f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 163, 70, 255))
                );

            _linaDragonSlaveTrack = new AnimationTrack("Lina Dragon Slave", 1.25f);
            _linaDragonSlaveTrack.SetFrame(0.0f,
                new AnimationFilledCircle(0, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.10f, Color.FromArgb(255, 80, 0))
                );
            _linaDragonSlaveTrack.SetFrame(0.9375f,
                new AnimationFilledCircle(0, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.75f, Color.FromArgb(255, 80, 0))
                );
            _linaDragonSlaveTrack.SetFrame(1.25f,
                new AnimationFilledCircle(0, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize, Color.FromArgb(0, 255, 80, 0))
                );

            _linaLightStrikeArrayTrack = new AnimationTrack("Lina Light Strike", 2.0f);
            _linaLightStrikeArrayTrack.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(0, 255, 80, 0))
                );
            _linaLightStrikeArrayTrack.SetFrame(0.49f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(0, 255, 80, 0))
                );
            _linaLightStrikeArrayTrack.SetFrame(0.5f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.1f / 2.0f, Color.FromArgb(255, 80, 0))
                );
            _linaLightStrikeArrayTrack.SetFrame(1.25f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.5f / 2.0f, Color.FromArgb(255, 80, 0))
                );
            _linaLightStrikeArrayTrack.SetFrame(2.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 255, 80, 0))
                );

            _nevermoreShadowrazeTrack = new AnimationTrack("Shadow Fiend Raze", 0.7f);
            _nevermoreShadowrazeTrack.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.5f / 2.0f, Color.FromArgb(255, 0, 0))
                );
            _nevermoreShadowrazeTrack.SetFrame(0.595f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.075f / 2.0f, Color.FromArgb(255, 0, 0))
                );
            _nevermoreShadowrazeTrack.SetFrame(0.7f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(0, 255, 0, 0))
                );

            _nevermoreRequiemTrack = new AnimationTrack("Shadow Field Requiem", 2.0f);
            _nevermoreRequiemTrack.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(255, 0, 0))
                );
            _nevermoreRequiemTrack.SetFrame(1.7f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.85f / 2.0f, Color.FromArgb(255, 0, 0))
                );
            _nevermoreRequiemTrack.SetFrame(2.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 255, 0, 0))
                );

            _zuusLightningBoltTrack = new AnimationTrack("Zeus Lighting Bolt", 0.5f);
            _zuusLightningBoltTrack.SetFrame(0.0f,
                new AnimationLine(new PointF(Effects.Canvas.WidthCenter, 0), new PointF(Effects.Canvas.WidthCenter, Effects.Canvas.Height), Color.FromArgb(0, 205, 255), 15)
                );
            _zuusLightningBoltTrack.SetFrame(0.425f,
                new AnimationLine(new PointF(Effects.Canvas.WidthCenter, 0), new PointF(Effects.Canvas.WidthCenter, Effects.Canvas.Height), Color.FromArgb(0, 205, 255), 15)
                );
            _zuusLightningBoltTrack.SetFrame(0.5f,
                new AnimationLine(new PointF(Effects.Canvas.WidthCenter, 0), new PointF(Effects.Canvas.WidthCenter, Effects.Canvas.Height), Color.FromArgb(0, 0, 205, 255), 15)
                );

            _zuusLightningBoltShadeTrack = new AnimationTrack("Zeus Lighting Bolt Shade", 0.5f);
            _zuusLightningBoltShadeTrack.SetFrame(0.0f,
                new AnimationLine(new PointF(Effects.Canvas.WidthCenter, 0), new PointF(Effects.Canvas.WidthCenter, Effects.Canvas.Height), Color.FromArgb(180, 0, 205, 255), 20)
                );
            _zuusLightningBoltShadeTrack.SetFrame(0.425f,
                new AnimationLine(new PointF(Effects.Canvas.WidthCenter, 0), new PointF(Effects.Canvas.WidthCenter, Effects.Canvas.Height), Color.FromArgb(180, 0, 205, 255), 20)
                );
            _zuusLightningBoltShadeTrack.SetFrame(0.5f,
                new AnimationLine(new PointF(Effects.Canvas.WidthCenter, 0), new PointF(Effects.Canvas.WidthCenter, Effects.Canvas.Height), Color.FromArgb(0, 0, 205, 255), 20)
                );

            _antimageBlinkTrack = new AnimationTrack("Anti-mage Blink", 0.5f);
            _antimageBlinkTrack.SetFrame(0.0f,
                new AnimationCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(128, 0, 255), 3)
                );
            _antimageBlinkTrack.SetFrame(0.5f,
                new AnimationCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize, Color.FromArgb(128, 0, 255), 3)
                );

            _antimageManaVoidTrack = new AnimationTrack("Anti-mage Void", 0.5f);
            _antimageManaVoidTrack.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.10f, Color.FromArgb(0, 0, 255))
                );
            _antimageManaVoidTrack.SetFrame(0.425f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.85f, Color.FromArgb(0, 0, 255))
                );
            _antimageManaVoidTrack.SetFrame(0.5f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize, Color.FromArgb(0, 0, 0, 255))
                );

            _antimageManaVoidCoreTrack = new AnimationTrack("Anti-mage Void Core", 0.5f);
            _antimageManaVoidCoreTrack.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(255, 255, 255))
                );
            _antimageManaVoidCoreTrack.SetFrame(0.425f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.25f, Color.FromArgb(255, 255, 255))
                );
            _antimageManaVoidCoreTrack.SetFrame(0.5f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.5f, Color.FromArgb(0, 255, 255, 255))
                );

            _ancientApparitionIceBlastTrack = new AnimationTrack("AA Ice Blast", 1.0f);
            _ancientApparitionIceBlastTrack.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(200, 200, 255))
                );
            _ancientApparitionIceBlastTrack.SetFrame(0.85f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.85f, Color.FromArgb(200, 200, 255))
                );
            _ancientApparitionIceBlastTrack.SetFrame(1.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize, Color.FromArgb(0, 200, 200, 255))
                );

            _axeBerserkersCallTrack = new AnimationTrack("Axe Berserker", 0.7f);
            _axeBerserkersCallTrack.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(255, 50, 0))
                );
            _axeBerserkersCallTrack.SetFrame(0.595f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.85f, Color.FromArgb(255, 50, 0))
                );
            _axeBerserkersCallTrack.SetFrame(0.7f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize, Color.FromArgb(0, 255, 50, 0))
                );

            _beastmasterPrimalRoarTrack = new AnimationTrack("BM Primal Roar", 1.0f);
            _beastmasterPrimalRoarTrack.SetFrame(0.0f,
                new AnimationFilledCircle(0, Effects.Canvas.HeightCenter, 0, Color.FromArgb(255, 200, 100))
                );
            _beastmasterPrimalRoarTrack.SetFrame(0.75f,
                new AnimationFilledCircle(0, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.75f, Color.FromArgb(255, 200, 100))
                );
            _beastmasterPrimalRoarTrack.SetFrame(1.0f,
                new AnimationFilledCircle(0, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize, Color.FromArgb(0, 255, 200, 100))
                );

            _brewmasterThunderClapTrack = new AnimationTrack("Brewmaster Thunder Clap", 1.5f);
            _brewmasterThunderClapTrack.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(170, 90, 0))
                );
            _brewmasterThunderClapTrack.SetFrame(0.75f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.5f, Color.FromArgb(170, 90, 0))
                );
            _brewmasterThunderClapTrack.SetFrame(1.5f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize, Color.FromArgb(0, 170, 90, 0))
                );
            ...
            _centaurHoofStompTrack.SetFrame(0.5f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.5f, Color.FromArgb(255, 50, 0))
                );
            ...
            chaosKnightChaosBoltProjectilePath.SetFrame(0.0f,
                new AnimationLine(new PointF(0, Effects.Canvas.HeightCenter), new PointF(0, Effects.Canvas.HeightCenter), Color.FromArgb(255, 70, 0), 3)
                );
            chaosKnightChaosBoltProjectilePath.SetFrame(0.25f,
                new AnimationLine(new PointF(0, Effects.Canvas.HeightCenter), new PointF(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter), Color.FromArgb(255, 70, 0), 3)
                );
            chaosKnightChaosBoltProjectilePath.SetFrame(0.5f,
                new AnimationLine(new PointF(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter), new PointF(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter), Color.FromArgb(0, 255, 70, 0), 3)
                );
            ...
            chaosKnightChaosBoltProjectile.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(175, 0, 0))
                );
            chaosKnightChaosBoltProjectile.SetFrame(0.25f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.5f, Color.FromArgb(0, 175, 0, 0))
                );
            ...
            _rattletrapRocketFlareTrack.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(255, 80, 0))
                );
            _rattletrapRocketFlareTrack.SetFrame(0.25f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.25f, Color.FromArgb(255, 80, 0))
                );
            _rattletrapRocketFlareTrack.SetFrame(0.5f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.5f, Color.FromArgb(0, 255, 80, 0))
                );
            ...
            _elderTitanEarthSplitterTrack.SetFrame(0.0f,
                new AnimationFilledRectangle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Width, Effects.Canvas.Height, Color.FromArgb(0, 255, 220))
                );
            _elderTitanEarthSplitterTrack.SetFrame(1.0f,
                new AnimationFilledRectangle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Width, Effects.Canvas.Height, Color.FromArgb(0, 0, 255, 220))
                );
            ...
            kunkkaTorrentBgTrack.SetFrame(0.0f,
                new AnimationFilledRectangle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Width, Effects.Canvas.Height, Color.FromArgb(0, 0, 0))
                );
            kunkkaTorrentBgTrack.SetFrame(0.5f,
                new AnimationFilledRectangle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Width, Effects.Canvas.Height, Color.FromArgb(0, 60, 80))
                );
            kunkkaTorrentBgTrack.SetFrame(3.6f,
                new AnimationFilledRectangle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Width, Effects.Canvas.Height, Color.FromArgb(0, 60, 80))
                );
            kunkkaTorrentBgTrack.SetFrame(4.0f,
                new AnimationFilledRectangle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Width, Effects.Canvas.Height, Color.FromArgb(0, 0, 60, 80))
                );

            var kunkkaTorrentSpashTrack = new AnimationTrack("Kunka Torrent Splash", 2.4f, 1.6f);

            kunkkaTorrentSpashTrack.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.1f / 2.0f, Color.FromArgb(0, 220, 245))
                );
            kunkkaTorrentSpashTrack.SetFrame(2.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize * 0.83f / 2.0f, Color.FromArgb(0, 220, 245))
                );
            kunkkaTorrentSpashTrack.SetFrame(2.4f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 0, 220, 245))
                );
            ...
            _kunkkaGhostshipTrack.SetFrame(0.0f,
                    new AnimationFilledCircle(-(Effects.Canvas.BiggestSize / 2.0f), Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 220, 245))
                    );
            _kunkkaGhostshipTrack.SetFrame(2.3f,
                new AnimationFilledCircle(Effects.Canvas.Width + (Effects.Canvas.BiggestSize / 2.0f) * 0.85f, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 220, 245))
                );
            _kunkkaGhostshipTrack.SetFrame(2.7f,
                new AnimationFilledCircle(Effects.Canvas.Width + (Effects.Canvas.BiggestSize / 2.0f), Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 0, 220, 245))
                );
            ...
            _legionCommanderOverwhelmingOddsTrack.SetFrame(0.0f,
                new AnimationFilledRectangle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Width, Effects.Canvas.Height, Color.FromArgb(0, 255, 145, 0))
                );
            _legionCommanderOverwhelmingOddsTrack.SetFrame(0.3f,
                new AnimationFilledRectangle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Width, Effects.Canvas.Height, Color.FromArgb(255, 145, 0))
                );
            ...
            _lifeStealerRageTrack.SetFrame(0.0f,
                new AnimationFilledRectangle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Width, Effects.Canvas.Height, Color.FromArgb(175, 0, 0))
                );
            _lifeStealerRageTrack.SetFrame(0.5f,
                new AnimationFilledRectangle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Width, Effects.Canvas.Height, Color.FromArgb(130, 0, 0))
                );
            ...
            _magnataurShockwaveTrack.SetFrame(0.0f,
                    new AnimationFilledCircle(-(Effects.Canvas.BiggestSize / 2.0f), Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 205, 255))
                    );
            _magnataurShockwaveTrack.SetFrame(0.9f,
                new AnimationFilledCircle(Effects.Canvas.Width + (Effects.Canvas.BiggestSize / 2.0f) * 0.9f, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 205, 255))
                );
            _magnataurShockwaveTrack.SetFrame(1.0f,
                new AnimationFilledCircle(Effects.Canvas.Width + (Effects.Canvas.BiggestSize / 2.0f), Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 0, 205, 255))
                );

            _omniknightPurificationTrack = new AnimationTrack("Omniknight Purification", 1.0f);
            _omniknightPurificationTrack.SetFrame(0.0f,
                    new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(255, 160, 0))
                    );
            _omniknightPurificationTrack.SetFrame(0.8f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(255, 160, 0))
                );
            _omniknightPurificationTrack.SetFrame(1.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 255, 160, 0))
                );

            _omniknightRepelTrack = new AnimationTrack("Omniknight Repel", 12.0f);
            _omniknightRepelTrack.SetFrame(0.0f,
                new AnimationFilledRectangle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Width, Effects.Canvas.Height, Color.FromArgb(255, 255, 255))
                );
            _omniknightRepelTrack.SetFrame(0.5f,
                new AnimationFilledRectangle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.Width, Effects.Canvas.Height, Color.FromArgb(150, 150, 255))
                );
            ...
            sandkingEpicenterWave1.SetFrame(0.0f,
                new AnimationCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(255, 160, 0), 4)
                );
            sandkingEpicenterWave1.SetFrame(0.5f,
                new AnimationCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(255, 160, 0), 4)
                );
            ...
            _slardarSlithereenCrushTrack.SetFrame(0.0f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, 0, Color.FromArgb(0, 150, 255))
                );
            _slardarSlithereenCrushTrack.SetFrame(0.45f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, (Effects.Canvas.BiggestSize / 2.0f) * 0.9f, Color.FromArgb(0, 150, 255))
                );
            _slardarSlithereenCrushTrack.SetFrame(0.5f,
                new AnimationFilledCircle(Effects.Canvas.WidthCenter, Effects.Canvas.HeightCenter, Effects.Canvas.BiggestSize / 2.0f, Color.FromArgb(0, 0, 150, 255))
                );
