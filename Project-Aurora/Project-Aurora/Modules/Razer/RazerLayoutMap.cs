...
public static class RazerLayoutMap
{
    ...
    {
        {DeviceKeys.MOUSEPADLIGHT1,               new[]{0, 1} },
        {DeviceKeys.MOUSEPADLIGHT2,               new[]{1, 1} },
        {DeviceKeys.MOUSEPADLIGHT3,               new[]{2, 1} },
        {DeviceKeys.MOUSEPADLIGHT4,               new[]{3, 1} },
        {DeviceKeys.MOUSEPADLIGHT5,               new[]{4, 1} },
        {DeviceKeys.MOUSEPADLIGHT6,               new[]{5, 1} },
        {DeviceKeys.MOUSEPADLIGHT7,               new[]{6, 1} },
        {DeviceKeys.MOUSEPADLIGHT8,               new[]{7, 1} },
        {DeviceKeys.MOUSEPADLIGHT9,               new[]{8, 1} },
        {DeviceKeys.MOUSEPADLIGHT10,              new[]{9, 1} },
        {DeviceKeys.MOUSEPADLIGHT11,              new[]{10, 1} },
        {DeviceKeys.MOUSEPADLIGHT12,              new[]{11, 1} },
        {DeviceKeys.MOUSEPADLIGHT13,              new[]{12, 1} },
        {DeviceKeys.MOUSEPADLIGHT14,              new[]{13, 1} },
        {DeviceKeys.MOUSEPADLIGHT15,              new[]{14, 1} },
        {DeviceKeys.MOUSEPADLIGHT16,              new[]{15, 1} },
        {DeviceKeys.MOUSEPADLIGHT17,              new[]{16, 1} },
        {DeviceKeys.MOUSEPADLIGHT18,              new[]{17, 1} },
        {DeviceKeys.MOUSEPADLIGHT19,              new[]{18, 1} },
        {DeviceKeys.MOUSEPADLIGHT20,              new[]{19, 1} },
    };
