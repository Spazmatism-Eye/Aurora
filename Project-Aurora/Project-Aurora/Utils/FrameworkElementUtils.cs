...
namespace AuroraRgb.Utils {
    public static class FrameworkElementExtensions {
        ...
        /// </summary>
        public static T WithBinding<T>(this T self, DependencyProperty dp, Binding binding, BindingMode? bindingMode = null, IValueConverter converter = null, UpdateSourceTrigger? updateSourceTrigger  = null) where T : FrameworkElement {
        ...
        /// Used in the TypeControlMap to shorten the code.
        /// </summary>
        public static T WithBinding<T>(this T self, DependencyProperty dp, object source, string path, BindingMode? bindingMode = null, IValueConverter converter = null, UpdateSourceTrigger? updateSourceTrigger = null) where T : FrameworkElement
            => self.WithBinding(dp, new Binding(path) { Source = source }, bindingMode, converter, updateSourceTrigger);
